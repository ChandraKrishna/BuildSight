...
urlpatterns = [
 ...
 path('reports/', views.reports, name='reports'), path('settings/', views.settings_view, name='settings'), path('settings/display-preferences/', views.update_display_preferences, name='display_preferences'), path('settings/backup/', views.database_backup, name='database_backup'), path('settings/restore/', views.database_restore, name='database_restore'),
]
